...
function OrderView() {
  ...
  return (
    <main className='display-flex'>
      ...
      <OrderProducts productsOrder={productsOrder} delProduct={delProductItemOrder} countTotal={totClient} totalClient={totalCountCli} sendOrder={sendOrder} resetOrder = {resetOrder} />
    </main>
  );
}
